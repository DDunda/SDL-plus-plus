...
static std::ostream& operator<<(std::ostream& os, const FPoint& v) { return os << (std::string)v; }
#pragma endregion
...
static std::ostream& operator<<(std::ostream& os, const Point& v) { return os << (std::string)v; }
#pragma endregion
...
static std::ostream& operator<<(std::ostream& os, const FRect& r) { return os << (std::string)r; }
#pragma endregion
...
static std::ostream& operator<<(std::ostream& os, const Rect& r) { return os << (std::string)r; }
